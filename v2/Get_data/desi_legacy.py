"""Independent DESI Legacy Surveys DR10 cone-search collector. No cross-match/classification."""
from pathlib import Path
import pandas as pd
CATALOG="DESI Legacy Surveys DR10"; VIZIER_CATALOG="VII/292/lsdr10"
def fetch(ra:float,dec:float,radius_arcmin:float)->pd.DataFrame:
 ...
 df=tabs[0].to_pandas()
 idc="objid";rac="RAJ2000";dcc="DEJ2000"
