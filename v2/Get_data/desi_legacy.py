...
CATALOG_NAME = "DESI / Legacy Surveys"
DESCRIPTION = "DESI/Legacy imaging and catalog measurements"

def fetch(region: QueryRegion) -> pd.DataFrame:
    """Fetch sources in region. Query logic belongs only to this adapter."""
    raise NotImplementedError("DESI / Legacy Surveys adapter query is not implemented yet")
