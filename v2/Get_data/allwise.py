"""Independent AllWISE cone-search collector via VizieR. No cross-match/classification."""
from pathlib import Path
import pandas as pd
CATALOG="AllWISE"; VIZIER_CATALOG="II/328/allwise"
def fetch(ra:float,dec:float,radius_arcmin:float)->pd.DataFrame:
 ...
 if "AllWISE" not in df.columns: raise KeyError("catalog identifier column missing")
 df.insert(0,"catalog",CATALOG);df.insert(1,"catalog_object_id",df["AllWISE"].astype("string"))
