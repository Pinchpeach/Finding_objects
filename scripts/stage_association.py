...
import pandas as pd
from finding_objects.association import association_score, CounterpartEvidence
...
def main():
    ...
    for _,r in d.iterrows():
        ...
        ev=association_score(CounterpartEvidence(source_band="SDSS", counterpart_band=str(r.survey), separation_arcsec=float(sep), source_poserr_arcsec=0.2, counterpart_poserr_arcsec=None, source_beam_arcsec=PSF.get(r.survey)))
